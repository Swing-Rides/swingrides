...
import {
  happenNextList,
  pageIntro,
  WhatHappenNextListProps,
} from "@/constants/reportIssue";
import { FieldSeparator } from "@/components/ui/field";
import ReportAnIssueForm from "@/components/forms/reportAnIssueForm";
import ReportAccountIssueForm from "@/components/forms/reportAccountIssueForm";
import ReusableTab from "@/components/tab";
                ...
                items={[
                  {
                    value: "booking",
                    label: "Booking Issue",
                    content: <ReportAnIssueForm />,
                  },
                  {
                    value: "account",
                    label: "Account Issue",
                    content: <ReportAccountIssueForm />,
                  },
                ]}
              />
              <span className="text-center text-gray-500 text-xs font-normal font-text leading-4 mt-2">
                Our support team will review your report and respond within 24
                hours. For urgent safety concerns please also call our support
                line directly.
              </span>
            </div>
          </div>
