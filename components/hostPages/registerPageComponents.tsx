  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_175_2032)">
        <path
          d="M19.5856 10.2199C19.5856 9.51135 19.5216 8.83082 19.4037 8.17627H9.99219V12.0416H15.3705C15.2591 12.653 15.025 13.2355 14.6822 13.7539C14.3393 14.2723 13.8949 14.7158 13.3759 15.0575V17.5658H16.6056C18.4953 15.825 19.5856 13.2628 19.5856 10.2199Z"
          fill="#4285F4"
        />
        <path
          d="M9.99234 19.9863C12.6905 19.9863 14.9529 19.0919 16.6058 17.5649L13.376 15.0577C12.4816 15.6572 11.3374 16.012 9.99234 16.012C7.38913 16.012 5.18566 14.2532 4.4012 11.8918H1.0625V14.4801C1.89394 16.1357 3.16942 17.5274 4.74639 18.4998C6.32336 19.4722 8.13968 19.9868 9.99234 19.9863Z"
          fill="#34A853"
        />
        <path
        ...
        />
        <path
          d="M9.99234 3.97426C11.4593 3.97426 12.7764 4.47891 13.8127 5.46923L16.6787 2.6032C14.9479 0.989317 12.6855 0 9.99234 0C6.08503 0 2.70736 2.23846 1.0625 5.5062L4.4002 8.09441C5.18565 5.73205 7.38913 3.97426 9.99234 3.97426Z"
          fill="#EA4335"
        />
      </g>
      <defs>
