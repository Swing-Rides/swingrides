                ...
                <div className='max-w-120 p-6 bg-white rounded-[10px] flex flex-col justify-start items-center gap-5'>
                        ...
                        <div>
                                <span className="text-[#333333] text-sm font-normal font-text leading-5">
                                        Sign into your account to complete your booking. It only takes 30 seconds.
                                </span>
                        </div>
                        ...
                        <div>
                                <span className="text-center text-[#6B7280] text-xs font-normal font-text leading-5">Don&apos;t have an account? <Link href={href} className='text-[#1A56DB]'>Sign Up →</Link> </span>
                        </div>
        ...
        return (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_297_8341)">
                                <path d="M19.5865 10.2199C19.5865 9.51135 19.5226 8.83082 19.4047 8.17627H9.99316V12.0416H15.3715C15.2601 12.653 15.026 13.2355 14.6831 13.7539C14.3403 14.2723 13.8959 14.7158 13.3768 15.0575V17.5658H16.6066C18.4963 15.825 19.5865 13.2628 19.5865 10.2199Z" fill="#4285F4" />
                                <path d="M9.99331 19.9863C12.6915 19.9863 14.9539 19.0919 16.6068 17.5649L13.377 15.0577C12.4826 15.6572 11.3384 16.012 9.99331 16.012C7.39011 16.012 5.18663 14.2532 4.40217 11.8918H1.06348V14.4801C1.89491 16.1357 3.17039 17.5274 4.74737 18.4998C6.32434 19.4722 8.14066 19.9868 9.99331 19.9863Z" fill="#34A853" />
                                ...
                                <path d="M9.99331 3.97426C11.4603 3.97426 12.7774 4.47891 13.8137 5.46923L16.6797 2.6032C14.9489 0.989317 12.6865 0 9.99331 0C6.08601 0 2.70834 2.23846 1.06348 5.5062L4.40117 8.09441C5.18663 5.73205 7.39011 3.97426 9.99331 3.97426Z" fill="#EA4335" />
                        </g>
                        <defs>
