...
export default function ModifyRentalFormFooter({ summary, onClose, handleCheckSummary, hostProvidingCoverage, insuranceDailyFee }: ModifyRentalFormFooterProps) {
        return (
                <>
                        {summary && (
                                <div className="p-4 bg-indigo-50 rounded-[10px] flex flex-col justify-start items-start gap-2">
                                        <div className="flex flex-col justify-start items-start gap-1 w-full">
                                                {summary.breakdown.map((item, i) => (
                                                        <div key={i} className="flex gap-3 justify-between items-center w-full">
