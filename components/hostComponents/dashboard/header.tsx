...
import { HeaderAvatarProps, HostNotificationType, NotificationCardProps, NotificationGroupsType } from "../types/navbar.type"
...
const initialTodayNotifications: NotificationCardProps[] = [
        {
                id: "1",
        ...
        },
        {
                ...
                unread: true,
                description: "Payment of $450 received for booking #B-1021.",
                time: "15 minutes ago",
        ...
        },
        {
                ...
                unread: true,
                description: "Sarah Williams checked in for booking #B-1018.",
                time: "1 hour ago",
                notificationType: "checkInOut",
        },
        {
                id: "4",
                title: "Maintenance Alert",
                unread: false,
                description: "Honda Civic (LKJ-234) is due for an oil change.",
                time: "2 hours ago",
        ...
        },
        {
                ...
                title: "New Message",
                unread: true,
                description: "Customer Mike asked about insurance coverage.",
                time: "3 hours ago",
        ...
        },
        {
                ...
                title: "New Booking Request",
                unread: false,
                description: "Emma Clarke booked Tesla Model 3 for 2 days.",
                time: "4 hours ago",
                notificationType: "newBooking",
        },
        {
                ...
                unread: false,
                description: "David Obi completed check-out for booking #B-1017.",
                time: "5 hours ago",
                notificationType: "checkInOut",
        },
]

const initialEarlierNotifications: NotificationCardProps[] = [
        {
                id: "8",
                title: "New Message",
                unread: false,
        ...
        },
        {
                ...
                title: "Payment Received",
                unread: false,
                description: "Payment of $320 received for booking #B-1015.",
        ...
        },
        {
                ...
                title: "New Booking Request",
                unread: false,
                description: "Alex Johnson booked Ford Explorer for 5 days.",
                time: "2 days ago",
                notificationType: "newBooking",
        },
        {
                ...
                title: "Maintenance Alert",
                unread: false,
                description: "BMW X5 (ABJ-501) brake pads need replacement.",
                time: "2 days ago",
                notificationType: "maintenanceAlert",
        },
        {
                ...
                title: "Payment Received",
                unread: false,
                description: "Payment of $780 received for booking #B-1012.",
                time: "3 days ago",
                notificationType: "paymentReceived",
        },
        {
                ...
                title: "New Message",
                unread: false,
                description: "Grace Nwosu asked about extended rental options.",
                time: "3 days ago",
                notificationType: "communication",
        },
        {
                ...
                title: "Check-In Alert",
                unread: false,
                description: "Tunde Bello checked in for booking #B-1010.",
                time: "4 days ago",
                notificationType: "checkInOut",
        },
        {
                ...
                title: "New Booking Request",
                unread: false,
                description: "Fatima Yusuf booked Hyundai Tucson for 7 days.",
                time: "5 days ago",
                notificationType: "newBooking",
        },
]
...
// ---------------------------------------------------------------------------
// Type map: select value → notification types that belong to that filter
// ---------------------------------------------------------------------------

type FilterValue = NotificationGroupsType["value"] | "communication" | "all"

const TAB_TYPE_MAP: Record<Exclude<FilterValue, "all">, HostNotificationType[]> = {
        bookings: ["newBooking"],
...
export function DashboardHeader() {
        ...
        const [todayNotifications, setTodayNotifications] = useState<NotificationCardProps[]>(initialTodayNotifications)
        const [earlierNotifications, setEarlierNotifications] = useState<NotificationCardProps[]>(initialEarlierNotifications)

        const unreadNotifications = [...todayNotifications, ...earlierNotifications].filter((n) => n.unread)
...
type NotificationProps = {
        unread: NotificationCardProps[]
        today: NotificationCardProps[]
        earlier: NotificationCardProps[]
        onMarkAllAsRead: () => void
}

const Notification = ({ unread, today, earlier, onMarkAllAsRead }: NotificationProps) => {
        return (
                <Popover>
...
const NotificationPanel = ({ today, earlier }: NotificationPanelProps) => {
        ...
        const applyFilter = (list: NotificationCardProps[]) => {
                ...
                const allowedTypes = TAB_TYPE_MAP[filter]
                return list.filter((n) => allowedTypes.includes(n.notificationType))
        }
        ...
        return (
                <div className="flex flex-col">
                        ...
                        <div className="px-4 pb-3">
                                <Select value={filter} onValueChange={(val) => setFilter(val as FilterValue)}>
                                        ...
                                        <SelectContent>
                                                {notificationGroups.map((group) => (
                                                        <SelectItem key={group.value} value={group.value} className="text-xs font-text">
                                                                {group.label}
                                                        </SelectItem>
                                                ))}
                                        </SelectContent>
                        ...
                        <div className="overflow-y-auto max-h-80.5 md:max-h-143">
                                <NotificationTabContent today={filteredToday} earlier={filteredEarlier} />
                        </div>
                </div>
        )
}
...
const NotificationTabContent = ({ today, earlier }: NotificationTabContentProps) => {
...
const NotificationCard = ({ id, title, unread, description, time, notificationType }: NotificationCardProps) => {
