      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
            ...
            >
              <IconInput
                ...
                {...register(
                  "firstName",
                  validators.name("First name") as RegisterOptions<
            ...
            >
              <IconInput
                ...
                {...register(
                  "lastName",
                  validators.name("Last name") as RegisterOptions<
                    ProfileCompanyFormValues,
                    "lastName"
                  >,
                )}
            ...
            >
              <IconInput
                ...
                {...register(
                  "phoneNumber",
                  validators.phone() as RegisterOptions<
                    ProfileCompanyFormValues,
                    "phoneNumber"
                  >,
                )}
        ...
        <Section title="Company Information">
          <FormRow
            label="Company Name"
            htmlFor="companyName"
            description="Company name can't be changed."
            className="w-full"
          >
            <IconInput
              id="companyName"
...
const FormRow = ({
  ...
  <div className={cn("flex flex-col gap-2", className)}>
    <Label
      htmlFor={htmlFor}
      className="text-gray-500 text-xs font-semibold font-text uppercase leading-4"
    >
      {label}
    </Label>
    {children}
