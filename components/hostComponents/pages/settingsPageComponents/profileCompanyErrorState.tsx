...
type ProfileCompanyErrorStateProps = {
        onRetry?: () => void;
};

export default function ProfileCompanyErrorState({
        onRetry,
}: ProfileCompanyErrorStateProps) {
        return (
                <div className="p-10 md:p-16 bg-white rounded-md border border-gray-200 flex flex-col items-center justify-center text-center gap-4">
                        ...
                        <div className="space-y-1">
                                ...
                                <p className="text-gray-500 text-sm font-normal font-text max-w-sm">
                                        Something went wrong while fetching your company details. Please
