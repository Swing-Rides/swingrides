...
import { IssueReportStatusTypes, ReportStatus } from "./reportAnIssuePageComponents"
...
interface SingleIssueReportPageProps {
        ...
        attachedPhotos: { id: string; src: string; }[];
...
export default function SingleIssueReportPage({ reportId, issueType, bookingReference, dateSubmitted, urgent, issueDescription, attachedPhotos, status, responseMessage, responseDate, respondedBy }: SingleIssueReportPageProps) {
        return (
                                ...
                                <div className="col-span-1 md:col-span-2 space-y-3 md:space-y-6">
                                        <CardWrapper>
                                                <div className="flex flex-col gap-3 md:gap-6">
                                                        ...
                                                        <div>
                                                                {urgent && <Badge className="p-1.5 bg-red-50 text-red-500">
                                                                        🔴 Marked as Urgent
                                                                </Badge>}
                                                        </div>
                                                        <Separator />
                                        ...
                                        <CardWrapper>
                                                <div className="space-y-5">
                                                        <h3 className="font-semibold text-base font-text leading-6">
                                                                Attached Photo{attachedPhotos.length > 1 ? 's' : ''} {attachedPhotos.length > 0 && `(${attachedPhotos.length})`}
                                                        </h3>
                                                        <Separator />
                                                        <div className="flex flex-wrap gap-2 justify-start items-center">
                                                                {attachedPhotos.length === 0 ? <EmptyImagePlaceholder /> : attachedPhotos.map((item) => (
                                                                        <div 
                                                                                key={item.id}
        ...
        return (
                <div className="space-y-4 md:space-y-6">
                        <div className="flex gap-2 items-center justify-start">
                                <span className="text-gray-500 text-sm font-medium leading-5 font-text" >Report An Issue</span>
