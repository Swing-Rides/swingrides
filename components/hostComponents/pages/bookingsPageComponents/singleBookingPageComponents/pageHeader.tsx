...
type BookingsStatus = 'active' | 'reserved' | 'confirmed' | 'completed' | 'cancelled' | 'noShow'
...
export default function PageHeader ({ id, status, handleEditBooking }: PageHeaderProps) {
                        ...
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-5">
                                <div className="flex flex-col justify-start items-start gap-2">
                                        ...
                                        <div className="flex justify-start items-center gap-3">
                                                ...
                                                <span className={`py-1 px-2.5 rounded-full text-xs font-semibold font-text leading-4 capitalize ${statusStyle}`}>
                                                        {status}
                                                </span>
                                        </div>
                                </div>
