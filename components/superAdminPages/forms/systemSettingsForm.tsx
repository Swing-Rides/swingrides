          ...
          {PLANS.map(({ key, label }) => (
            ...
            >
              ...
              <FormRow
                ...
                error={
                  (
                    errors.plans?.[key]?.maxVehicles as
                      | { message?: string }
                      | undefined
                  )?.message
                }
              ...
              <FormRow
                ...
                error={
                  (
                    errors.plans?.[key]?.monthlyPrice as
                      | { message?: string }
                      | undefined
                  )?.message
                }
              >
                <div className="relative flex items-center">
                  ...
                  <Input
                    ...
                    step={0.01}
                    className={cn(
                      inputCn(!!errors.plans?.[key]?.monthlyPrice),
                      "pl-7",
                    )}
...
const FormRow = ({
  ...
  <div className="flex flex-col gap-1.5">
    <Label
      htmlFor={htmlFor}
      className="text-gray-500 text-xs font-medium font-text uppercase"
    >
      {label}
    </Label>
    {children}
